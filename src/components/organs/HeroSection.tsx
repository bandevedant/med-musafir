...
const HeroSection = () => {
    return (
        <div id="home" className="w-full lg:h-screen md:h-[550px] h-[830px] relative overflow-x-hidden flex justify-end">
                ...
                <div className="flex flex-col justify-center md:gap-6 gap-3 md:order-1 order-2">
                    ...
                    <div className="w-full flex md:justify-start justify-between items-center lg:gap-12 md:gap-6 gap-0">
                        <Button  type="button" className="outline-none border-none lg:px-7 px-5 py-3 bg-color2 text-white font-extralight rounded-lg">
                            <a href="https://drive.google.com/file/d/1BsSY5YM0ufl90sXM0c1Clhs_EHmwy_UL/view?fbclid=PAZXh0bgNhZW0CMTEAAaZDB0fTtOUc3F5kyJQosS-Fx-pBiC2pyBlu74cNhcFsA0Qn_8Wl-LtU2O8_aem_AXMBvVAXwdOp-Kz_ZOHcjKMoHH9ZxMHoHQDa5x2M5zH2WDm49NJBOuRmtiNeVjeMEdHUTqsxYgWEVsDgaBp7wiuE" className="outline-none border-none lg:px-7 px-5 py-3 bg-color2 text-white font-extralight rounded-lg">
                        ...
                        <div className="flex items-center lg:gap-6 gap-3 cursor-pointer">
                            ...
                            <Button type="button" className="outline-none border-none">
                                <a href="https://www.instagram.com/reel/C2rvSR2qGiJ/?igsh=MW5xb3hubjhrOTB2bw==" className="outline-none border-none">
