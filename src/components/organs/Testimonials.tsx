...
const Testimonials = () => {
    ...
    return (
        <div id="testimonials" className="w-full h-auto flex flex-col items-start justify-center relative lg:px-24 md:px-10 px-6 mt-36 gap-5">
