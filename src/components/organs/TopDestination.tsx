...
import City3 from "../../assets/group8.jpg"
import City4 from "../../assets/City3.jpg"
import City5 from "../../assets/City4.jpg"
import City6 from "../../assets/group9.jpg"
...
const TopDestination = () => {
    ...
    return (
        <div id="destinations" className="w-full h-auto flex flex-col items-center justify-center relative lg:px-24 md:px-20 px-6 my-20">
